                ...
                <div className='flex flex-col space-y-4'>
                    <div className='flex flex-col space-y-2'>
                        ...
                        <p className='text-sm leading-5 md:text-base md:leading-7'>
                            This website you&rsquo;re on right now! I built it using
                            Next.js, Tailwind CSS, Framer Motion and TypeScript connected to
                            Notion as a CMS.
                        </p>
                    </div>
                    <br />
                    <div className='flex flex-col space-y-2'>
                        ...
                        <p className='text-sm leading-5 md:text-base md:leading-7'>
                            A robot that can recognize and translate Chilean Sign Language.
                            I built it using Python, TensorFlow and Arduino.
                        </p>
                    </div>
                    <br />
                    <div className='flex flex-col space-y-2'>
